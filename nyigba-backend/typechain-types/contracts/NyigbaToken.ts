...
export interface NyigbaTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DOMAIN_SEPARATOR"
...
export namespace MintingDisabledEvent {
  export type InputTuple = [];
  export type OutputTuple = [];
  export interface OutputObject {}
  export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>;
...
export interface NyigbaToken extends BaseContract {
  connect(runner?: ContractRunner | null): NyigbaToken;
  waitForDeployment(): Promise<this>;

  interface: NyigbaTokenInterface;
  ...
  getEvent(
    ...
    MintingDisabledEvent.InputTuple,
    MintingDisabledEvent.OutputTuple,
    MintingDisabledEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    ...
    "MintingDisabled()": TypedContractEvent<
      MintingDisabledEvent.InputTuple,
      MintingDisabledEvent.OutputTuple,
      MintingDisabledEvent.OutputObject
    >;
